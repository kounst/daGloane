...
MODEL                = complementary_controller
MODULES              = complementary_controller_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE             = complementary_controller.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:\Users\Matthias\Desktop\DaGloane_Project\SW\src\simulink_control
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
...
SHARED_LIB           = 
TARGET_LANG_EXT      = c
MEX_OPT_FILE         = -f "$(MATLAB_BIN)\$(ML_ARCH)\mexopts\mssdk71opts.bat"
VISUAL_VER           = 7.1SDK
...
MODELLIB                  = complementary_controllerlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = complementary_controller_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\complementary_controller_grt_rtw
